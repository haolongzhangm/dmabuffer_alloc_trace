...
const typename DwarfOp<AddressType>::OpHandleFuncPtr DwarfOp<AddressType>::kOpHandleFuncList[] = {
  ...
  nullptr,
  &DwarfOp<AddressType>::op_deref,
  &DwarfOp<AddressType>::op_deref_size,
  &DwarfOp<AddressType>::op_push,
  &DwarfOp<AddressType>::op_dup,
  &DwarfOp<AddressType>::op_drop,
  &DwarfOp<AddressType>::op_over,
  &DwarfOp<AddressType>::op_pick,
  &DwarfOp<AddressType>::op_swap,
  &DwarfOp<AddressType>::op_rot,
  &DwarfOp<AddressType>::op_abs,
  &DwarfOp<AddressType>::op_and,
  &DwarfOp<AddressType>::op_div,
  &DwarfOp<AddressType>::op_minus,
  &DwarfOp<AddressType>::op_mod,
  &DwarfOp<AddressType>::op_mul,
  &DwarfOp<AddressType>::op_neg,
  &DwarfOp<AddressType>::op_not,
  &DwarfOp<AddressType>::op_or,
  &DwarfOp<AddressType>::op_plus,
  &DwarfOp<AddressType>::op_plus_uconst,
  &DwarfOp<AddressType>::op_shl,
  &DwarfOp<AddressType>::op_shr,
  &DwarfOp<AddressType>::op_shra,
  &DwarfOp<AddressType>::op_xor,
  &DwarfOp<AddressType>::op_bra,
  &DwarfOp<AddressType>::op_eq,
  &DwarfOp<AddressType>::op_ge,
  &DwarfOp<AddressType>::op_gt,
  &DwarfOp<AddressType>::op_le,
  &DwarfOp<AddressType>::op_lt,
  &DwarfOp<AddressType>::op_ne,
  &DwarfOp<AddressType>::op_skip,
  &DwarfOp<AddressType>::op_lit,
  &DwarfOp<AddressType>::op_reg,
  &DwarfOp<AddressType>::op_regx,
  &DwarfOp<AddressType>::op_breg,
  &DwarfOp<AddressType>::op_bregx,
  &DwarfOp<AddressType>::op_nop,
  &DwarfOp<AddressType>::op_not_implemented
};
